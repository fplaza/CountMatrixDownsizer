...
TEST_DIR=tests/input/4.no_count_matrix
...
${COUNT_MATRIX_DOWNSIZER} --target-read-count ${TARGET_READ_COUNT} --num-repetitions ${NUM_REPETITIONS} --downsized-matrix ${DOWNSIZED_MATRIX} --stats ${STATS}
