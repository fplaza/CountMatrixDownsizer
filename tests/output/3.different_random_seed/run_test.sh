...
${COUNT_MATRIX_DOWNSIZER} --count-matrix ${TEST_DATA} --target-read-count ${TARGET_READ_COUNT} --num-repetitions ${NUM_REPETITIONS} --seed ${RANDOM_SEED} --downsized-matrix ${DOWNSIZED_MATRIX} --stats ${STATS}
